...
st.set_page_config(
    page_title="RAG Document Upload Test",
    page_icon="📄",
    layout="wide"
)
...
# Sidebar navigation
page = st.sidebar.selectbox("Choose a page", ["Upload Documents", "Query Documents", "View Documents"])
    ...
    if query and st.button("Search", type="primary"):
        with st.spinner("Searching..."):
            ...
            if result:
                ...
                st.write("**Processing Time:**", f"{result.get('processing_time', 0):.2f} seconds")
